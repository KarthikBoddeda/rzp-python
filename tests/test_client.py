...
from rzp._utils import maybe_transform
from rzp._models import BaseModel, FinalRequestOptions
from rzp._constants import RAW_RESPONSE_HEADER
from rzp._exceptions import RzpError, APIStatusError, APITimeoutError, APIResponseValidationError
from rzp._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
from rzp.types.payment_link_create_params import PaymentLinkCreateParams
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(
                    object,
                    maybe_transform(
                        dict(amount=1000, currency="INR", description="Payment for policy no"), PaymentLinkCreateParams
                    ),
                ),
